...
public class Command implements Serializable {
     ...
     * @param identifier Class name of the item you wish to create. Such as
     * boat, freighter or train.
     * @param contents List of Containers. It holds all the containers in it's
     * cargo hold.
     */
     ...
     * @param target the target parameter is used to identify the point or
     * object to move to.
     */
     ...
     * @param identifier the identifier parameter is used to grab the desired
     * object. This can be an AGV or a crane.
    ...
    /**
     * The toString method allows you to print all the information this object
     * holds.
     *
     * @return Object information, such as the command, identifier, orx, ory and
     * orz value in a single string.
     */
    @Override
